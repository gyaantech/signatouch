              ...
              // echo $row_count;
                if($row_count == 1)
                    ...
                    $result_arr = array('HdrID' => $row['HdrID'],
                                        ...
                                        'FacilityNPI' => isset($row['FacilityNPI']) ? $row['FacilityNPI'] : '',
                                        'FacilityID' => isset($row['FacilityID']) ? $row['FacilityID'] : '',
                                        'FacilityName' => isset($row['FacilityName']) ? $row['FacilityName'] : '',
                                        'FacilityAddr1' => isset($row['FacilityAddr1']) ? $row['FacilityAddr1'] : '',
                                        'FacilityAddr2' => isset($row['FacilityAddr2']) ? $row['FacilityAddr2'] : '',
                                        'FacilityCity' => isset($row['FacilityCity']) ? $row['FacilityCity'] : '',
                                        'FacilityST' => isset($row['FacilityST']) ? $row['FacilityST'] : '',
                                        'FacilityZip' => isset($row['FacilityZip']) ? $row['FacilityZip'] : '',
                                        'FacilityPhone' => isset($row['FacilityPhone']) ? $row['FacilityPhone'] : '',
