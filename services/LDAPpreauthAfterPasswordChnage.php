<?php
// Test for Zimbra Preauth access after changing password
//
// Ver 1
// Thu sept 12 EDT 2014
// -------------------------------------
...
class LDAP {
  ...
  public function set_user_parameters() { // return username, password and domain name
    ...
    if(!isset($_SESSION['password'])){
      $_SESSION['password'] = $_POST['txtRChangePassword']; 
  }
    if(!isset($_SESSION['username'])){
      $_SESSION['username'] = $_POST['HiddenInputID'];
    }
    ...
    $user_post = isset($user) ? $user :'';
      ...
      $GetSet->setemailID($user_post);
      $username = $GetSet->getemailID();
